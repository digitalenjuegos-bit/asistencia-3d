...
const COURSES = {
  ...
  "Historia_1BGU_B": {
    ...
    students: [
      ...
      { num: 3, name: "HIDALGO DROUET SAMANTHA" },
      { num: 4, name: "DVORQUEZ SAMAN EITAN" },
      { num: 5, name: "ENCALADA ZAMBRANO PATRICK OLIVIER" },
      { num: 6, name: "FLORES SANCHEZ VALENTINA" },
      { num: 7, name: "GARCÉS CABEZAS DOMÉNICA ISABELLA" },
      { num: 8, name: "GONZALEZ LOPEZ ISABELLA ALEJANDRA" },
      { num: 9, name: "GONZALEZ VELASCO ESTEFANÍA" },
      { num: 10, name: "HOYOS ESPIN AMANDA LIA" },
      { num: 11, name: "LABRE GALARZA RAFAELLA" },
      { num: 12, name: "NARANJO OJEDA MAIHA" },
      { num: 13, name: "MOSCOSO MARTINEZ ALICIA MARIA" },
      { num: 14, name: "MUECKAY SALVATIERRA LUCAS XAVIER" },
      { num: 15, name: "NAHT MUÑOZ DOMENICA ANTONELLA" },
      ...
      { num: 19, name: "TAPIA GARZON ANDRES JESUS" },
      { num: 20, name: "VALLEJO HERDOIZA NICOLÁS ANDRES" },
      { num: 21, name: "WENDT LANDIVAR NATHALIE FABIANA" },
      { num: 22, name: "ZAMBRANO MOREIRA MARIA VICTORIA" },
      { num: 23, name: "ZAPATIER PEREZ LEONARDO" },
      { num: 24, name: "SOLORZANO SEBASTIAN" }
    ]
  },
  "Historia_1BGU_C": {
